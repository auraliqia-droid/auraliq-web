...
export function ServicesGrid() {
  return (
    <section id="servicios" className="py-14 scroll-mt-24 bg-[linear-gradient(180deg,#FBF8F1,transparent_65%)]">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-12 items-start">
          <div className="space-y-6">
            <h2 data-animate="fade-up" className="text-3xl md:text-4xl font-semibold text-foreground">Lo esencial de Auraliq IA</h2>
